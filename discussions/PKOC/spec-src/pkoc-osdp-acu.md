...
Several new tags are introduced, for error responses and transaction id tracking:
...
Transaction ID Set-up
---------------------

The PD needs the transaction id to perform the Authentication Request.
...
1.50   editorial changes to text
       removed redundant transaction identifier tag
       removed osdp_RAW message 
       remove PD-side transaction ID generation
```
